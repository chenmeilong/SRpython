...
#设置代理IP
proxy_addr="110.52.235.100:9999"
...
def use_proxy(url,proxy_addr):
    ...
    req.add_header("User-Agent","Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2623.221 Safari/537.36 SE 2.X MetaSr 1.0")    #浏览器标识符
