#8-9的代码 网络结构中的全连接 卷积 池化 全部用 tf.contrib.layers 改写
...
y_conv = tf.contrib.layers.fully_connected(nt_hpool2_flat,10,activation_fn=tf.nn.softmax)     #全连接作为输出层
...
for i in range(2000):#20000    #15000 大概运行2小时
