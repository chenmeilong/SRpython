#seq2seq预测 下一个时刻数据效果  2层GRU，每层12节点     P299
import random
import math
...
dec_outputs, dec_memory = tf.contrib.legacy_seq2seq.basic_rnn_seq2seq(encoder_input,decode_input,Mcell)   #Mcell定义的网络
