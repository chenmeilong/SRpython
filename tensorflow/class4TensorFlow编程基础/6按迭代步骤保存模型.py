...
learning_rate = 0.01
optimizer = tf.train.GradientDescentOptimizer(learning_rate).minimize(cost) #Gradient descent梯度下降
...
training_epochs = 20
display_step = 2
saver = tf.train.Saver(max_to_keep=1) # 生成saver  max_to_keep=1生成模型会覆盖以前的模型
savedir = "log/"
# 启动session
