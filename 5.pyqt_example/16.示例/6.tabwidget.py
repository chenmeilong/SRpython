...
class Ui_Form(object):
    def setupUi(self, Form):     #  Form  是  QWidget
        Form.setObjectName("Form")
        Form.resize(781, 503)
        self.gridLayout = QtWidgets.QGridLayout(Form)   #继承QWidget中放一个网格
        self.gridLayout.setObjectName("gridLayout")
        self.tabWidget = QtWidgets.QTabWidget(Form)    #继承QWidget中放一个tabWidget
        self.tabWidget.setTabsClosable(True)
        self.tabWidget.setObjectName("tabWidget")
        self.tab = QtWidgets.QWidget()
        self.tab.setObjectName("tab")
        self.pushButton = QtWidgets.QPushButton(self.tab)  #QWidget  self.tab 里面放置了按钮
        self.pushButton.setGeometry(QtCore.QRect(60, 90, 81, 31))  #60, 90表示按钮的起始位置   81,31表示按钮的长宽
        font = QtGui.QFont()
